...
public class ServiceRegistry implements Watcher {
    ...
    private void createServiceRegistryZnode() {
        try {
            // Race condition beteen exists and create method -- if 2 nodes call exists at the same time, then they will
            // both get null and proceed to create the same registry znode.
            // However zookeeper solves this problem by allowing only one call through create method, the second call
            // with throw keeperException
